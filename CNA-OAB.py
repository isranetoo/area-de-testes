...
class SessaoCNA:
    """
        Arquivos:
            output_cna_oab: local onde o resultado da pesquisa do advogado

        Args: 
            NomeAdvo: input onde se digita o nome do advogado para a pesquisa 
    """
    def __init__(self, NomeAdvo: str):
        """Iniciando a sessão com o arqgumentos"""
